...
export function PushNotificationToggle({ memberId }: Props) {
  ...
  return (
    <div className="flex items-center justify-between gap-4 rounded-2xl border border-[var(--line)] bg-white/70 px-4 py-3">
      <div className="flex items-center gap-3">
        {subscribed ? (
          <Bell className="size-5 text-[var(--leaf-600)]" />
        ) : (
          <BellOff className="size-5 text-[var(--ink-500)]" />
        )}
        <div>
