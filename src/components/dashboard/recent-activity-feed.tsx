          ...
          return (
            ...
            >
              ...
              <p className="min-w-0 flex-1 text-sm leading-5">
                <strong className="font-semibold text-ink-950">{actor}</strong>
                {" "}{verb}{" "}
                <em className="not-italic font-semibold text-ink-950">{taskTitle}</em>
                {" "}
                <span className="text-ink-500 text-xs">{timeSuffix}</span>
              </p>
